...
public class Account {
    ...
    public void deposit (double amount) throws Exception {
        try {
            ...
            balance += amount;
            System.out.println("Deposit of " + amount + " success. The new balance is " + this.balance);
        }catch (Exception e) {
            e.printStackTrace();
            throw e;
        }
    ...
    public void withdraw (double amount, String ssn) throws Exception {
        try {
            ...
            balance -= amount;
            System.out.println("Withdraw of " + amount + " success. The new balance is " + this.balance);
    ...
    /**
     * Retutn the {@link  Account} state in {@link String} format.
     * @return
