...
//            }
    ...
    /**
     * Returns the result based on choice, and the inputs. If the input\
     ...
     *                  4 for Div, 5 for Mod. Any other choice lead to an error
    ...
    public static int div (int num1, int num2) {
        if (num2 == 0) {
            return Integer.MIN_VALUE;   //θα το χρησιμοποιήσουμε ως error code
        }
        return  num1 / num2;
    }
